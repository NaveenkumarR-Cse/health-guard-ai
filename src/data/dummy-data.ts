...
export const patientRecords = [
  { id: "P001", name: "Ranjit Das", age: 34, village: "Mawsynram", disease: "Cholera", status: "Active", date: "2026-02-10" },
  { id: "P002", name: "Meena Devi", age: 28, village: "Silchar", disease: "Dysentery", status: "Recovered", date: "2026-02-08" },
  { id: "P003", name: "Bimal Nath", age: 45, village: "Dimapur", disease: "Typhoid", status: "Active", date: "2026-02-11" },
  { id: "P004", name: "Priya Sharma", age: 22, village: "Shillong", disease: "Diarrhea", status: "Recovered", date: "2026-02-07" },
  { id: "P005", name: "Kamal Singh", age: 56, village: "Mawsynram", disease: "Hepatitis A", status: "Active", date: "2026-02-12" },
];
