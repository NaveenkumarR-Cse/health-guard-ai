    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img src={heroBg} alt="Rural Northeast India landscape with river and farmland" className="w-full h-full object-cover" />
      ...
      <section className="py-16 bg-muted/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <AnimatedCounter end={1247} label="Cases Tracked" />
            <AnimatedCounter end={47} label="Villages Monitored" />
            <AnimatedCounter end={156} label="Health Workers" />
            <AnimatedCounter end={94} label="Recovery Rate" suffix="%" />
          </div>
        </div>
      </section>
